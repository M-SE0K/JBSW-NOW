...
export default function HeroBanner() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? "#1E1B4B" : "#312E81" }]}>
      ...
      <View style={styles.content}>
        <View style={styles.badgeRow}>
          <View style={[styles.badge, { backgroundColor: isDark ? "rgba(99, 102, 241, 0.3)" : "rgba(99, 102, 241, 0.3)" }]}>
            <Text style={styles.badgeText}>전북권 3개 대학 통합 플랫폼</Text>
          </View>
          <View style={styles.geminiBadge}>
            <Ionicons name="sparkles" size={18} color="#FCD34D" />
            <Text style={styles.geminiText}>Gemini Pro 분석 기반</Text>
          </View>
        </View>
        ...
        <View style={styles.buttonRow}>
          ...
          >
            <Text style={styles.primaryButtonText}>맞춤 정보 설정</Text>
          ...
          <View style={styles.universityButtons}>
            {universities.map((univ, idx) => (
              ...
              >
                <Text style={[styles.universityText, { color: univ.color }]}>
                  {univ.name}
                </Text>
              </View>
            ))}
